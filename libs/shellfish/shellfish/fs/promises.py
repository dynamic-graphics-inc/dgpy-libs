...
async def wbytes_async(
    ...
    Examples:
        >>> from shellfish.fs.promises import rbytes_async, wbytes_async
...
async def rbytes_gen_async(
    ...
    Examples:
        ...
        >>> from shellfish.fs.promises import wbytes_gen_async, rbytes_gen_async
...
async def rjson_async(filepath: FsPath) -> Any:
    ...
    Examples:
        ...
        >>> from asyncio import run
        >>> from shellfish.fs.promises import rjson_async, wjson_async
